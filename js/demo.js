...
// Code from the site - turn into a function and pass in nodes and links
function createData(nodes, links){
    
    // Code from the site for making the orders
...
d3.select('#order-select').on('change', function() {
    chart.update(chart.orders.get(this.value)) // gets the value in the order-select (in HTML) for the new ordering
});
